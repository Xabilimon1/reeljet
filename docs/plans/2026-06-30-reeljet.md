...
**Tech Stack:** Python 3 (anaconda) + Pillow, pytest, ffmpeg (CLI), Higgsfield MCP. Repo at `~/x-brain/Projects/reeljet`, symlinked into `~/.claude/skills/reeljet`.
...
```bash
ln -snf ~/x-brain/Projects/reeljet ~/.claude/skills/reeljet
...
- Centralized x-brain I/O → Task 8 (`--campaign-dir`), SKILL.md Phase 0. ✓
